                ...
                <div class="section-detail">
                    ...
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            ...
                            <input style="height: 38px;width: 250px;border: 1px solid #cccccc;padding: 6px 12px;"
                                type="password" name="password" id="address">
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="?modules=users&controllers=index&action=crateAccount" name="form-checkout">
                    ...
                    <div class="form-row clearfix">
                        ...
                        <div class="form-col fl-right">
                            ...
                            <input style="height: 38px;width: 275px;border: 1px solid #cccccc;padding: 6px 12px;"
                    ...
                    <div class="form-row">
                        ...
                        <input
                            style="display: inline-block;padding-bottom: 10px; width: 100%;border: 1px solid #cccccc;padding: 6px 12px;"
                            name="fullname" id="">
                        <div class="form-col">
