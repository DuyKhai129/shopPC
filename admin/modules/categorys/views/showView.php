            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <?php };?>
                        ...
                        <input type="submit" name="btn_submit" id="btn-submit" value="Cập Nhật" style="height: 40px;border-radius: 60px;width: 150px;color: green;border-color: white;color: white;background-color: #48ad48;">
