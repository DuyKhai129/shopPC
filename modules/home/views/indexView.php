                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            ...
                            <h3 class="title">FreeShip toàn quốc</h3>
                        ...
                        <li>
                            ...
                            <p class="desc">1900.8080</p>
                        </li>
                        <li>
                            <div class="thumb">
                                <img src="public/images/icon-3.jpg">
                            </div>
                            <h3 class="title">Tiết kiệm nhiều hơn</h3>
                        ...
                        <li>
                            ...
                            <div class="price">
                                <span style="display: block;" class="new">
                                    <?php echo format_currency($value['promotional_price']) . '.VNĐ'; ?>
                                </span>
