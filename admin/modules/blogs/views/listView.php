        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?modules=blogs&controllers=index&action=add" title="" id="add-new" class="fl-left">Thêm
                        mới</a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-operation ">
                                            <li><a href="?modules=blogs&controllers=index&action=edit&id=<?php echo $value['id']; ?>"
                                                    title="Sửa" class="edit"><i class="fa fa-pencil"
                                                        aria-hidden="true"></i></a></li>
                                            <li><a href="?modules=blogs&controllers=index&action=delete&id=<?php echo $value['id']; ?>"
