            ...
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    ...
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị <?php if(!empty($data['0'])) echo count($data['0']);else echo '0' ;?>
                            kết quả trong <?php if(!empty($data['4'])) echo count($data['4']);else echo '0' ; ?> kết quả
                        </p>
                    ...
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            ...
                            <div class="price">
                                ...
                                <span class="old"><?php echo format_currency($value['price']).' .VNĐ'; ?></span>
                            </div>
                    ...
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            <a <?php if($i == $data['2']) echo 'style="background-color: green;"';  ?>
                                href="?modules=search&controllers=index&action=search&page=<?php echo $i; ?>&key_word=<?php echo $data['3']; ?>"
                                title=""><?php echo $i; ?></a>
                        </li>
                        <?php }; ?>
                    </ul>
