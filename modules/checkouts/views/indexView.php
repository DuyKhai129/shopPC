                    ...
                    <table class="shop-table">
                        ...
                        <tbody>
                            ...
                            <tr class="cart-item">
                                ...
                                <td class="product-total"><?php echo format_currency($value['sub_total'])." VND"; ?>
                                </td>
                            </tr>
                            <?php }}; ?>
                        </tbody>
                        <tfoot>
                            <tr class="order-total">
                                <td>Tổng đơn hàng:</td>
                                <td><strong
                                        class="total-price"><?php if(isset($_SESSION['cart']['buy'])) echo format_currency($_SESSION['cart']['info']['total'])." VND"; else echo "0 VND"; ?></strong>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
