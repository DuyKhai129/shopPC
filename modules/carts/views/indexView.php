                        ...
                        <tfoot>
                                ...
                                <td colspan="7">
                                    <div class="clearfix">
                                        <p id="total-price" class="fl-right">Tổng giá:
                                            <span><?php if(isset($_SESSION['cart']['buy'])&&!empty($_SESSION['id_customer'])) echo format_currency($_SESSION['cart']['info']['total'])." .VNĐ"; else echo "0 .VNĐ"; ?></span>
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7">
                                    <div class="clearfix">
                                        <div class="fl-right">
                                            <a style="margin-right: 865px;background-color: #953c1d;"
                                                href="?modules=checkouts&controllers=index&action=story" title=""
                                                id="checkout-cart">Lịch sử đơn hàng</a>
                                            <a href="?modules=checkouts&controllers=index&action=index"
                                                style="background-color: #d9263c;" title="" id="checkout-cart">Thanh
                                                toán</a>
                                        </div>
                                    </div>
                                </td>
