                                ...
                                <div style=" display: flex;">
                                    <div style="width: 400px;">
                                        ...
                                        <input type="text" name="name" id="product-name"
                                            value="<?php echo $value['name']; ?>" style=" display: block;width: 300px;">
                                        ...
                                        <input type="text" name="promotional_price" id="price" value="<?php echo $value['promotional_price']; ?>"
                                    ...
                                    <div style="width: 400px;">
                                        ...
                                        <input type="text" name="operating_system" id="price" value="<?php echo $value['operating_system']; ?>"
                                            style="display: block;width: 300px;">
