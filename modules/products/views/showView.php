            ...
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    ...
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị trên 50 sản phẩm</p>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            <a <?php if($i == $data['4']) echo 'style="background-color: green;"';  ?>
                                href="?modules=products&controllers=index&action=show&id_cat=<?php echo($data['3']) ; ?>&page=<?php echo $i; ?>"
                                title=""><?php echo $i; ?></a>
                        </li>
                        <?php }; ?>
                    </ul>
