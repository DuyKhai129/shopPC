<div id="footer-wp">
    <div id="foot-body">
        <div class="wp-inner clearfix">
            <div class="block" id="info-company">
                ...
                <p class="desc">LAPTOP-PRO luôn cung cấp sản phẩm chính hãng có thông tin rõ ràng, chính sách ưu đãi cực
                    lớn cho khách hàng có thẻ thành viên.</p>
                <div id="payment">
                    <div class="thumb">
            ...
            <div class="block menu-ft" id="info-shop">
                ...
                <ul class="list-item">
                    ...
                    <li>
                        <p>0964.789.123 - 0999.989.989</p>
                    </li>
                    <li>
                        <p>fafu123@gmail.com</p>
                    </li>
                </ul>
            </div>
    ...
    <div id="foot-bot">
        <div class="wp-inner">
            <p id="copyright">© Bản quyền thuộc về DUYKHAI | LOCALSTORE</p>
        </div>
    </div>
</div>
</div>
<div id="menu-respon">
    <a href="?page=home" title="" class="logo">LAPTOP-PRO</a>
